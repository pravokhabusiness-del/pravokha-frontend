                            ...
                            <PopoverContent className="w-80 rounded-2xl p-6 border-border/40 shadow-xl bg-card">
                              <div className="space-y-4">
                                ...
                                <div className="space-y-2.5">
                                  ...
                                  <div className="flex justify-between items-center text-xs font-medium">
                                    <span className="text-muted-foreground">Marketplace Fee ({payoutStats.commissionRate.toFixed(1)}%)</span>
              ...
              <CardContent className="space-y-6 p-6 pt-0">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-muted/20 p-4 rounded-xl border border-border/40">
                    ...
                    <span className="text-sm font-bold">₹{((payoutStats as any).minPayoutAmount || 500).toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center bg-muted/20 p-4 rounded-xl border border-border/40">
