                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-center w-full mt-2">
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="w-full border-dashed border-primary/50 hover:border-primary text-xs flex items-center justify-center gap-2 py-1 h-auto text-muted-foreground hover:text-primary transition-colors"
                            onClick={() => {
                                googleLogin("mock_test_token");
                                toast({
                                    title: "Dev Bypass Activated",
                                    description: "Simulating Google Account Sign-In...",
                                });
                            }}
                        >
                            <span className="text-amber-500">⚡</span> Test Google SSO (Bypass Config Error)
                        </Button>
                    </div>
