        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
                <motion.div variants={item}>
                    <Button 
                        variant="outline" 
                        className="w-full h-20 flex-col gap-2 rounded-xl border-border/60 bg-card hover:bg-primary/5 hover:border-primary/40 group transition-all"
                ...
                <motion.div variants={item}>
                    ...
                    >
                        <LayoutGrid className="w-5 h-5 text-emerald-500 group-hover:scale-110 transition-transform" />
                ...
                <motion.div variants={item}>
                    ...
                    >
                        <TrendingUp className="w-5 h-5 text-rose-500 group-hover:scale-110 transition-transform" />
