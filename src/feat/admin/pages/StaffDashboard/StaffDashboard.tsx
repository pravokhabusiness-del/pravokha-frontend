        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                <motion.div variants={item} onClick={() => navigate('/admin/orders')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-blue-500 h-full">
                ...
                <motion.div variants={item} onClick={() => navigate('/admin/tickets')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-rose-500 h-full">
                        <CardContent className="p-4 flex flex-col items-center text-center gap-2 justify-center h-full">
                ...
                <motion.div variants={item} onClick={() => navigate('/admin/products/add')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-primary h-full">
                        <CardContent className="p-4 flex flex-col items-center text-center gap-2 justify-center h-full">
                ...
                <motion.div variants={item} onClick={() => navigate('/admin/products/manage')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-amber-500 h-full">
                        <CardContent className="p-4 flex flex-col items-center text-center gap-2 justify-center h-full">
                ...
                <motion.div variants={item} onClick={() => navigate('/admin/categories')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-emerald-500 h-full">
                        <CardContent className="p-4 flex flex-col items-center text-center gap-2 justify-center h-full">
                ...
                <motion.div variants={item} onClick={() => navigate('/admin/customers')} className="cursor-pointer">
                    <Card className="hover:bg-accent/50 transition-colors cursor-pointer border-l-4 border-l-indigo-500 h-full">
                        <CardContent className="p-4 flex flex-col items-center text-center gap-2 justify-center h-full">
