...
export function LearnMorePage() {
    return (
        <div className="min-h-screen">
            {/* Hero Section */}
            <section className="relative bg-gradient-hero py-20 text-foreground overflow-hidden">
                <img 
                    src={learnMoreBg} 
                    alt="" 
            ...
            <section className="py-16">
                <div className="container mx-auto px-4 md:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center bg-gradient-hero p-8 md:p-12 rounded-2xl text-foreground relative overflow-hidden">
                        <img 
                            src={learnMoreBg} 
                            alt="" 
