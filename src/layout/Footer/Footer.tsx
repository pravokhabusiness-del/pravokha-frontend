        ...
        <footer className={styles.footer}>
            ...
            <div className={styles.mainContent}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 text-sm">
                    ...
                    {/* Newsletter */}
                    <div className="lg:col-span-1">
                        <h4 className="font-semibold mb-4 text-foreground uppercase tracking-wider text-xs">Stay Updated</h4>
                        <form onSubmit={handleNewsletterSubmit} className="relative">
                            <Input
                                ...
                                className="w-full h-10 text-sm bg-muted/30 border-primary/20 focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-primary rounded-full pr-24 transition-all"
                                required
                            />
                            <Button 
                                type="submit" 
                                size="sm" 
                                className="absolute right-1 top-1 h-8 rounded-full text-xs font-semibold px-4 hover:scale-105 transition-transform bg-primary text-primary-foreground"
