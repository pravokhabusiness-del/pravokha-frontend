        ...
        <DropdownMenu open={open} onOpenChange={setOpen}>
            <DropdownMenuTrigger className="focus:outline-none">
                <div className={styles.triggerContainer}>
                    ...
                    {(role?.toLowerCase() === "admin" || role?.toLowerCase() === "super_admin" || role?.toLowerCase() === "vendor" || role?.toLowerCase() === "seller") && (
                        <div className={cn(styles.roleBadge, getRoleBadgeClass(role))}>
                            {(role?.toLowerCase() === "admin" || role?.toLowerCase() === "super_admin") ? "A" : "S"}
                        </div>
                    )}
                </div>
            </DropdownMenuTrigger>
